...
resource "aws_appautoscaling_policy" "up" {
  name               = "${var.app_name}_${var.stage}_scale_up" # "cb_scale_up"
  service_namespace  = "ecs"
  resource_id        = "service/${aws_ecs_cluster.main.name}/${aws_ecs_service.main.name}"
  scalable_dimension = "ecs:service:DesiredCount"
...
resource "aws_appautoscaling_policy" "down" {
  name               = "${var.app_name}_${var.stage}_scale_down" # "cb_scale_down"
  service_namespace  = "ecs"
  resource_id        = "service/${aws_ecs_cluster.main.name}/${aws_ecs_service.main.name}"
  scalable_dimension = "ecs:service:DesiredCount"
...
resource "aws_cloudwatch_metric_alarm" "service_cpu_high" {
  alarm_name          = "${var.app_name}_${var.stage}_cpu_utilization_high" # "cb_cpu_utilization_high"
...
resource "aws_cloudwatch_metric_alarm" "service_cpu_low" {
  alarm_name          = "${var.app_name}_${var.stage}_cpu_utilization_low" # "cb_cpu_utilization_low"
